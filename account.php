...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  if(strlen($username) < 3 || strlen($username) > 16){
    $username_errors["short"] = "user name should be between 3 and 16 characters";
  }
 ...
 $details_statement = $connection->prepare($details_query);
  $details_statement->bind_param("isssssssss",$account_id,$firstname,$lastname,$streetnumber,$unit,$street,$suburb,$state,$country,$postcode);
...
$user_query = "SELECT
               ...
               user_details.street_number AS streetnumber,
               ...
               user_details.image_name AS image
               FROM accounts LEFT JOIN user_details 
  ...
  <body>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  ...
                  <input  type="text" class="form-control" id="street-number" name="number" placeholder="42" value="<?php echo $streetnumber; ?>">
                </div>
              </div>
              <!--Street Name-->
              <div class="col-md-8">
    ...
    <div class="container">
      <div class="row col-md-2">
        <img src="userimages/<?php echo $image;?>"  height='80' width='80'>
      </div>
